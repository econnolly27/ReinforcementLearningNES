...
def test(opt):
    ...
    opt.saved_path = os.getcwd() + '/gradius/a3c/' + opt.saved_path
    ...
    if torch.cuda.is_available():
        ...
        model.load_state_dict(torch.load(
            "{}/a3c_gradius".format(opt.saved_path)))
        model.cuda()
    else:
        model.load_state_dict(torch.load("{}/a3c_gradius".format(opt.saved_path),
