...
def get_args():
    ...
    parser.add_argument("--log_path", type=str, default="tensorboard/ppo_gradius")
...
def train(opt):
    ...
    while True:
        ...
        if tot_loops % opt.save_interval == 0 and tot_loops > 0:
            torch.save(model.state_dict(), "{}/PPO_gradius_{}_{}".format("trained_models", opt.world, opt.stage))
            torch.save(model.state_dict(), "{}/PPO_gradius_{}_{}_{}".format("trained_models", opt.world, opt.stage, tot_loops))
