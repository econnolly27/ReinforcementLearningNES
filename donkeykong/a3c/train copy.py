...
def get_args():
    ...
    parser.add_argument("--log_path", type=str, default="tensorboard/a3c_donkey_kong_")
...
def train(opt):
    ...
    if opt.load_from_previous_stage:
        ...
        file_ = "{}/a3c_donkey_kong_{}_{}".format(opt.saved_path, previous_world, previous_stage)
