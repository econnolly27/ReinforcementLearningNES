...
def test(opt):
    ...
    opt.saved_path = os.getcwd() + '/pacman/a3c/' + opt.saved_path
    savefile = opt.saved_path + '/pacman_a3c_test' + opt.timestr + '.csv'
    print(savefile)
    title = ['Score']
    ...
    if torch.cuda.is_available():
        ...
        model.load_state_dict(torch.load(
            "{}/a3c_pacman".format(opt.saved_path)))
        model.cuda()
    else:
        model.load_state_dict(torch.load("{}/a3c_pacman".format(opt.saved_path),
