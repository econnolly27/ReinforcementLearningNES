...
def get_args():
    ...
    parser.add_argument("--log_path", type=str,
                        default="tensorboard/ppo_pacman" + timestr)
...
def train(opt):
    ...
    savefile = opt.saved_path + '/pacman_PPO_train' + opt.timestr + '.csv'
    print(savefile)
    ...
    while True:
        ...
        if tot_loops % opt.save_interval == 0 and tot_loops > 0:
            ...
            ), "{}/PPO_pacman_{}_{}".format(opt.saved_path, opt.world, opt.stage))
            torch.save(model.state_dict(), "{}/PPO_pacman_{}_{}_{}".format(
