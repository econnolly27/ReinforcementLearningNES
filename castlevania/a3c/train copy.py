...
def get_args():
    ...
    parser.add_argument("--log_path", type=str, default="tensorboard/a3c_castlevania")
...
def train(opt):
    ...
    opt.saved_path = os.getcwd() + '/castlevania/a3c/' + opt.saved_path
    ...
    if opt.load_from_previous_stage:
        ...
        file_ = "{}/a3c_castlevania_{}_{}".format(opt.saved_path, previous_world, previous_stage)
